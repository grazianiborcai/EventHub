...
import static com.example.a01547598.datastream.MainFragment.RequestPermissionCode;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstFragment = (MainFragment) fm.findFragmentById(R.id.contener_fragment);
            ...
            case RequestPermissionCode:
                if (grantResults.length > 0) {
                    ...
                    if (StoragePermission && RecordPermission && InternetPermission && NetWorkPermission) {
                        ...
                        firstFragment.startRecord();
                    }
                    else {
                        Toast.makeText(MainActivity.this,"Permission Denied",Toast.LENGTH_LONG).show();
                        firstFragment.setAudioSwitchCheck(false);
                    }
                }
